...
public class CoachingAppLoginPage extends BasePageAction {
	...
	@FindBy(xpath = "//div[text()=\"Welcome!\"]/following-sibling::div[1]")
	...
	public CoachingAppLoginPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
